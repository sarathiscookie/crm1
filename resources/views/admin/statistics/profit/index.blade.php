...
@section('title', 'Profit Analyze')

@section('content')
    <div class="main-content">
        <div class="page-header">
            <h3 class="page-title">Profit Analyze</h3>
            <ol class="breadcrumb">
                <li><a href="">Home</a></li>
                <li class="">Statistics</li>
                <li class="active">Profit Analyze</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-sm-12">
                            ...
                            <div class="col-md-12 m-b-3">
                                <div class="col-xl-8 col-lg-6 m-b-2">
                                    ...
                                    <div class="col-xl-2 col-lg-6 m-b-2">
                                        <button class="btn btn-primary ladda-button dateDifference" data-style="expand-left"><span class="ladda-label">Show Profit</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    <script>
        ...
        /* Chart loads with three months data */
        var Charts = function () {
        ...
        jQuery(document).ready(function() {
            ...
            $(".dateDifference").on("click", function(){
                ...
                $.post('{{ route('statisticsProfitShow') }}', {fromDate: fromDate, toDate: toDate}, function(response){
                    $('#lineChart').hide();
